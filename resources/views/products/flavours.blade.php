                                ...
                                <div class="modal-content">
                                    <form action="{{ route('flavours.store') }}" method="POST">
                                        ...
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="addDataTitle">Add Flavour</h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="flavour_name" name="name"
                                                    required>
                                            </div>
                                        </div>
                                    ...
                                    <tbody>
                                        @foreach ($flavours as $item)
                                            ...
                                            <div id="editData{{ $item->id }}" class="modal fade" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <form action="{{ route('flavours.update', $item->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="mb-3">
                                                                    <label for="flavour_name"
                                                                        class="form-label">Flavour</label>
                                                                    <input type="text" class="form-control"
                                                                        id="flavour_name" name="name"
