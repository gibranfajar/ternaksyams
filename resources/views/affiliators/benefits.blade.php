@extends('Layouts.app')
@section('title', 'Affiliator Benefits')
@section('content')
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-between align-items-start flex-wrap">
                                <h3 class="mb-1">Affiliator Benefits</h3>
                        ...
                        <div id="addData" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="addDataTitle"
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable"
                                ...
                                <div class="modal-content">
                                    <form action="{{ route('affiliator-benefits.store') }}" method="POST"
                                    ...
                                    <tbody>
                                        @foreach ($benefits as $benefit)
                                            <tr>
                                                ...
                                                <td>
                                                    <form
                                                        action="{{ route('affiliator-benefits.changeStatus', $benefit->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('PUT')
                                                ...
                                                <td class="text-center align-middle">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        ...
                                                        <form
                                                            action="{{ route('affiliator-benefits.destroy', $benefit->id) }}"
                                            ...
                                            <div id="editData{{ $benefit->id }}" class="modal fade" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable"
                                                    ...
                                                    <div class="modal-content">
                                                        <form
                                                            action="{{ route('affiliator-benefits.update', $benefit->id) }}"
